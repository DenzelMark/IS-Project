...
if(isset($_POST['submit'])){
    ...
    customers`(`file`, `title`, `date`, `location`, `content`, `link`) 
    VALUES ('$file_name', '$_POST[title]', '$_POST[date]', '$_POST[location]', '$_POST[content]', '$_POST[link]')");
                    ...
                    <h3 class="mini-headign">create an event</h3>
                     <div class="post-text">
                         <form action="eventdb.php" method="post" enctype="multipart/form-data">
                             ...
                             <input type="file" name="image" placeholder="add a image">
                             <br><br>
                             <label>Title</label>
